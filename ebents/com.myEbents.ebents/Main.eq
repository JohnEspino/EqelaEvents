...
public class Main : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        ...
        rsc.prepare_image("myDaimos","daimos",0.5*get_scene_width(),0.5*get_scene_height());
        image1 = add_sprite_for_image(SEImage.for_resource("myDaimos"));
        image1.move(0,0);
       
        rsc.prepare_image("myGundam","gundam",0.5*get_scene_width(),0.5*get_scene_height());
        image2 = add_sprite_for_image(SEImage.for_resource("myGundam"));
        image2.move(0.5*get_scene_width(),0);
       
        rsc.prepare_image("myMazinger","mazinger",0.5*get_scene_width(),0.5*get_scene_height());
        image3 = add_sprite_for_image(SEImage.for_resource("myMazinger"));
        image3.move(0,0.5*get_scene_height());
       
        rsc.prepare_image("myVoltes","voltes",0.5*get_scene_width(),0.5*get_scene_height());
        image4 = add_sprite_for_image(SEImage.for_resource("myVoltes"));
